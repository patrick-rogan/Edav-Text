...
#Introduction
Throughout this report we will be exploring a data set that includes presidential speeches from George Washington (1790) to Barack Obama (2016). Within this report there were several areas that we wanted to explore such as visualizing the speeches, how the speeches might be related in terms of Political Party and Presidential Rating, and also within the aspect of time. We will show this through multiple methods such as dimension reduction, sentimental analysis, word frequencies and cosine similarities.We will start with visualizations using different methods of dimension reduction to explore Political Party, Presidential Rating and Year of the speech.
...
#Conclusion
Throughout this report we have explored many different methods in understanding textual data. We have seen visualizations using dimension reduction, sentiment analysis and word counts to allow many different approaches to viewing a set of documents. Many different insights have been discussed about these documents and we can see that some of the approaches allow for potential extra features, such as dimension reduction and sentiment analysis, that could help with a machine learning task such as classification or predicting the year. 
